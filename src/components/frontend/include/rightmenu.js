...
const Rightmenu = ({ email }) => {
    ...
    useEffect(() => {
        ...
        try {
            const response = await axios.get(`/api/users/singleUserBalance/${email}`);
        ...
        <div className="betslip-wrapper">
            ...
            <div className="combo-box">
                <ul className="nav">
                    ...
                    <Link className="nav-link link-secondary" id="combo-tab" data-bs-toggle="tab" data-bs-target="#coombo" to="#"><span>Single bets</span></Link>
                    </li>
                    <li className="nav-item">
                    <Link className="nav-link link-secondary active" id="bets-tab" data-bs-toggle="tab" data-bs-target="#bbets" to="#"><span>Combo</span></Link>
                    </li>
                </ul>
