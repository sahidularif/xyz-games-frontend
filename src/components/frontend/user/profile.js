...
//   user balance received report start
...
//   user balance received report end
...
//   // Render error message if there was an error during data fetching
//   if (error) {
         ...
         <div className="profile-section pb-20">
            <div className="container">
                ...
                <ul className="nav">
                    ...
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="profile-tab02" data-bs-toggle="tab" data-bs-target="#profile3" href="#"><span>Rewards</span></a>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                        <a className="nav-link link-secondary" id="profile-tab05" data-bs-toggle="tab" data-bs-target="#profile6" href="#"><span>Log out</span></a>
                    </li>
                    </ul>   
                </div>
                            ...
                            <div className="row">
                                <div className="col-xxl-5 col-xl-12">
                                    <div className="date-wrap">
                                        ...
                                        <span className="icon"><i className="fas fa-thumbtack"></i></span>
                                        </div>
                                        <div className="items">
                            ...
                            <div className="col-xxl-6 col-xl-12">
                                <div className="form-grp form-label">
                                    <label className="form-check-label d-flex align-items-center" for="coun">
                                        <input className="form-check-input" type="checkbox" value="" id="coun" checked />
